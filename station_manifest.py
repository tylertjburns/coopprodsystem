...
s1 = Station(id=StationType.DUMMY_1.name, input_reqs=input_reqs, output=outputs, production_timer_sec_callback=lambda: 3)
...
s2 = Station(id=StationType.DUMMY_2.name, input_reqs=input_reqs, output=outputs, production_timer_sec_callback=lambda: 3)
...
s3 = Station(id=StationType.DUMMY_3.name, input_reqs=input_reqs, output=outputs, production_timer_sec_callback=lambda: 3)
